...
class AutoCookieWebScraper:
    ...
    def scrape(self, path: str, params: dict = None) -> None:
        ...
        # 提取 positions 数据
        positions_data = response.json()['data']['positions']
        print("positions_data",positions_data)
        self.excel_out_1(positions_data)
        self.excel_out_2(positions_data)
...
if __name__ == "__main__":
    ...
    params = {
        ...
        'csecplatform': '4',
        'csecversion': '2.4.0',
        'mtgsig': '%7B%22a1%22%3A%221.1%22%2C%22a2%22%3A1733494942646%2C%22a3%22%3A%227x3059v88y925u1518zw20wwzu1wx6v58060x9w8zv4979589771uwv2%22%2C%22a5%22%3A%22LRhx15AvGgVlS5SlzxNNUI%3D%3D%22%2C%22a6%22%3A%22hs1.4aOG4x69iuIGtADfqn9IKcZRvJhUHva43kN8xuj0PhWvWTKjeWclwe%2FfN2xZAm9g8cuh%2BEHA%2BMUMZdFqoPwoDCQ%3D%3D%22%2C%22x0%22%3A4%2C%22d1%22%3A%2275280a98d80370c167ae5b3bad2b7a55%22%7D'
    }
